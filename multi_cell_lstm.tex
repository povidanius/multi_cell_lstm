...
Where $i_{t}$, $f_{t}$, $o_{t}$ are calles input, forget and output gates, $\tilde{c}_{t}$ - candidate cell vector, $c_{t}$ - cell vector, and $h_{t}$ - hidden state vector. All aforementioned variables are $D_{h}$- dimensional.
